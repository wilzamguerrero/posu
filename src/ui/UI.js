    ...
    return [
      ...
      },
      {
        ...
        options: [
          ...
          { icon: 'scaling', title: 'Deformar el hueso: escalar el trozo elegido (R)', path: 'scene.tool', value: 'scale' },
          ...
          { sep: true },
          { icon: 'undo-2', title: 'Deshacer el ultimo cambio (Ctrl+Z)', onClick: () => actions.undo?.() },
