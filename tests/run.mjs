...
const suites = ['figure.test.mjs', 'stage.test.mjs', 'perspective.test.mjs', 'hands.test.mjs', 'mocap.test.mjs', 'graphics.test.mjs', 'watchdog.test.mjs', 'scene.test.mjs', 'ui.test.mjs'];
