...
const suites = ['figure.test.mjs', 'figures.test.mjs', 'library.test.mjs', 'stage.test.mjs', 'perspective.test.mjs', 'hands.test.mjs', 'mocap.test.mjs', 'graphics.test.mjs', 'watchdog.test.mjs', 'scene.test.mjs', 'search.test.mjs', 'ui.test.mjs'];
